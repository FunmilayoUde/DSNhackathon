...
CREATE TABLE Bestbrain_school.Student (
    ...
    Class_Level VARCHAR(4) CHECK (Class_Level IN ('JSS1', 'JSS2', 'SS1', 'SS2', 'SS3')) NOT NULL,  -- Class level choices
...
CREATE TABLE Bestbrain_school.Teachers (
    ...
    FOREIGN KEY (Student_ID) REFERENCES Bestbrain_school.Student (Student_ID)  -- Reference the students table
);
